document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- MAQUINA DE ESCRIBIR ---
    const welcomeMsg = "My love for you is like an ocean, it continues as far as the eye can see and seems endless. True love begins where there is no longer any expectation of a reward.";
    ...
    // --- MÚSICA ---
    const playlist = [
        { title: "Hello!", artist: "Adele", src: "audio/audio.mp3" },
    ];
